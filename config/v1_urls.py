...
from batches.views import BatchViewSet, ActivityScheduleViewSet, BatchActivityViewSet
...
router.register(r'farmer-subscriptions', FarmerSubscriptionViewSet)
router.register(r'farmer-subscription-resources', FarmerSubscriptionResourceViewSet)
